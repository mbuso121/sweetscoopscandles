...
const PRODUCTS = [
  {
    ...
    longDescription: "The signature of the collection. A creamy vanilla base is topped with a hand-piped strawberry whipped swirl, then finished with a second soft scoop layer and a tiny candy strawberry — built to look exactly like a scoop of strawberries-and-cream ice cream, right down to the cherry-on-top wick. Every swirl is piped by hand, so no two candles are ever completely identical.",
    ...
    materials: "Soy wax blend, cotton wick, decorative wax toppers, glass tumbler",
  ...
  },
  {
    ...
    longDescription: "A rich, textured chocolate scoop rests on a smooth two-tone base and is finished with a miniature wax chocolate square for a true melted-chocolate-scoop look. A warm, comforting flavour that works beautifully as a gift or a treat for yourself.",
    size: "Approx. 200ml glass tumbler",
    scent: "Deep cocoa and warm vanilla",
    burnTime: "Approx. 15–18 hours",
    materials: "Soy wax blend, cotton wick, decorative wax topper, glass tumbler",
    availability: "Made to Order",
  ...
  },
  {
    ...
    longDescription: "A generous strawberry whipped swirl is piped over a smooth vanilla base and finished with a small candy strawberry topper. Light, fresh and one of our best-selling scent pairings.",
    size: "Approx. 200ml glass tumbler",
  ...
  },
  {
    ...
    longDescription: "Our most understated design: a soft whipped strawberry swirl piped over a creamy vanilla base, with no added toppers. A lovely everyday candle for anyone who wants the whipped texture without the extra decoration.",
    size: "Approx. 200ml glass tumbler",
    scent: "Fresh strawberry over a soft vanilla base",
    burnTime: "Approx. 16–19 hours",
    materials: "Soy wax blend, cotton wick, glass tumbler",
    availability: "Made to Order",
  ...
  },
  {
    ...
    longDescription: "Five of our signature mini scoop candles — chocolate, vanilla, strawberry, bubblegum and marshmallow — presented together as a set. Each mini scoop is hand-shaped and unscented-free (fully fragranced), making this the easiest way to try the whole flavour range or put together a ready-made gift. Presented gift-wrapped, ready to hand over as is.",
    ...
    materials: "Soy wax blend, cotton wicks",
    availability: "Made to Order",
